  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Home</span> / <b>Atleti</b></>}>
              <AnalystOnly>
                <AthletesListPage />
              </AnalystOnly>
            </AppShell>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Atleti</span> / <b>Profilo</b></>}>
              <AnalystOnly>
                <AthletePage />
              </AnalystOnly>
            </AppShell>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Home</span> / <b>Squadre</b></>}>
              <AnalystOnly>
                <TeamsListPage />
              </AnalystOnly>
            </AppShell>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Squadre</span> / <b>Profilo</b></>}>
              <TeamPage />
            </AppShell>
          </Protected>
        }
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Match</span> / <b>Nuovo</b></>}>
              <AnalystOnly>
                <NewMatchPage />
              </AnalystOnly>
            </AppShell>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Match</span> / <b>Recap</b></>}>
              <MatchRecapPage />
            </AppShell>
          </Protected>
        }
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Config</span> / <b>Azioni</b></>}>
              <AnalystOnly>
                <ActionsConfigPage />
              </AnalystOnly>
            </AppShell>
      ...
      <Route
        ...
        element={
          <Protected>
            <AppShell breadcrumbs={<><span>Config</span> / <b>Import</b></>}>
              <AnalystOnly>
                <ImportExcelPage />
              </AnalystOnly>
            </AppShell>
